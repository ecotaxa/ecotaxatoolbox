...
function [base_regroup] = f_regroup_allIFCB(table_groupage,base)
...
Ybv_Summed_plain_Area_BV_spectra=base.Ybv_Summed_plain_Area_BV_spectra;
Bv=base.Bv;
...
Ybv_Summed_plain_Area_BV_spectra_t=sum(Ybv_Summed_plain_Area_BV_spectra,2);
Bv_t=sum(Bv);
...
for i=1:size(new_groups,1)
    ...
    Ybv_Summed_plain_Area_BV_spectra_r=Ybv_Summed_plain_Area_BV_spectra(:,f_ng);
    Bv_r=Bv(f_ng);
    
    Ab_n1(i)=sum(Ab_r);
    %Yab_n1(:,i)=sum(Yab_r,2);
    Ybv_Plain_Area_BV_spectra_n1(:,i)=sum(Ybv_Plain_Area_BV_spectra_r,2);
    Ybv_Summed_plain_Area_BV_spectra_n1(:,i)=sum(Ybv_Summed_plain_Area_BV_spectra_r,2);
    Bv_n1(i)=sum(Bv_r);
    ssn1(:,i)=sum( ss_r,2);
...
for i=1:size(new_groups,1)
    ...
    Ybv_Summed_plain_Area_BV_spectra_n2(:,i)=sum(Ybv_Summed_plain_Area_BV_spectra_r,2);
    Bv_n2(i)=sum(Bv_r);
    ssn2(:,i)=sum( ss_r,2) ;
...
for i=1:size(new_groups,1)
    ...
    Ybv_Summed_plain_Area_BV_spectra_n3(:,i)=sum(Ybv_Summed_plain_Area_BV_spectra_r,2);
    Bv_n3(i)=sum(Bv_r);
    ssn3(:,i)=sum( ss_r,2);
...
Ybv_Summed_plain_Area_BV_spectra_regroup=[Ybv_Summed_plain_Area_BV_spectra Ybv_Summed_plain_Area_BV_spectra_t Ybv_Summed_plain_Area_BV_spectra_n1 Ybv_Summed_plain_Area_BV_spectra_n2 Ybv_Summed_plain_Area_BV_spectra_n3];
...
base_regroup.Ybv_Ybv_Summed_plain_Area_BV_spectra=Ybv_Summed_plain_Area_BV_spectra_regroup;
