...
for i=1:m
    ...
    for fracnb=1:nfrac
        ...
        [base_Zooscan SStot] = process_abundances_biovolumes_NBSSspectra_zooscan(subset,base_Zooscan,smin,smax,k,uu,zoo_groups,i,fracnb);
    end
end
...
for i=1:m
    ...
    for fracnb=1:nfrac
        if fracnb==1
            ...
            eval(['Ybv_Riddled_Area_BV_spectra=base_Zooscan(i).d' num2str(fracnb) '.Ybv_Riddled_Area_BV_spectra;'])
            ...
            eval(['Ybv_Riddled_Area_BV_spectra=nansum(cat(3,Ybv_Riddled_Area_BV_spectra, base_Zooscan(i).d' num2str(fracnb) '.Ybv_Riddled_Area_BV_spectra),3);'])
    ...
    base_Zooscan(i).tot.Ybv_Riddled_Area_BV_spectra = Ybv_Riddled_Area_BV_spectra;
...
table_groupage=readtable('zooregroup_zooscan.xlsx','ReadVariableNames',false);  %all copoda as herbivorous
